...
{
	var costo1 = document.getElementById("precio1").checked;
	var costo2 = document.getElementById("precio2").checked;
	...
	else if (costo1==false && costo2==true) 
	{
